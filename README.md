...
| Docker (or any BuildKit daemon)  · docker run -d --name buildkitd --privileged moby/buildkit | Image pull / push / BuildKit backend | [Docker Desktop](https://docs.docker.com/get-docker/) | [Docker Engine](https://docs.docker.com/engine/install/) · `docker run -d --name buildkitd --privileged moby/buildkit` |
